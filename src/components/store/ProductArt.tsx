...
export default function ProductArt({ product, color, className }: ProductArtProps) {
  ...
  return (
    ...
    >
      {/* Plain color field — no gradients, no check/grid pattern. */}
      <rect width="400" height="300" fill="#101016" />
...
function renderObject(
  ...
  switch (product.category) {
    case "sneakers":
      return (
        <g>
          <ellipse cx="200" cy="248" rx="130" ry="14" fill="#000000" opacity="0.55" />
          <path
    ...
    case "tech":
      return (
        <g>
          <ellipse cx="200" cy="246" rx="120" ry="12" fill="#000000" opacity="0.55" />
          {product.id === "p07" ? (
            <g>
              <circle cx="200" cy="150" r="64" fill={selected} />
            ...
            <g>
              <rect x="182" y="88" width="36" height="150" rx="18" fill={selected} />
            ...
            <g>
              <rect x="118" y="120" width="164" height="108" rx="26" fill={selected} />
    ...
    case "accessories":
      return (
        <g>
          <ellipse cx="200" cy="248" rx="118" ry="12" fill="#000000" opacity="0.55" />
          {product.id === "p03" ? (
            <g>
              <path
            ...
            <g>
              <path d="M120 150 L280 150" stroke={selected} strokeWidth="34" strokeLinecap="round" />
            ...
            <g>
              <path d="M128 116 L272 116 L258 196 C258 208 156 208 150 196 Z" fill={selected} />
    ...
    case "lifestyle":
      return (
        <g>
          <ellipse cx="200" cy="248" rx="110" ry="12" fill="#000000" opacity="0.55" />
          {product.id === "p10" ? (
            <g>
              <rect x="152" y="128" width="96" height="104" rx="10" fill={selected} />
            ...
            <g>
              <rect x="158" y="120" width="84" height="110" rx="8" fill={selected} />
    ...
    default:
      return (
        <g>
          <ellipse cx="200" cy="252" rx="120" ry="13" fill="#000000" opacity="0.55" />
          {product.id === "p12" ? (
            <g>
              <path d="M138 122 C138 108 158 102 200 102 C242 102 262 108 262 122 L252 200 C252 212 148 212 148 200 Z" fill={selected} />
            ...
            <g>
              <path d="M150 96 C166 88 186 86 200 86 C214 86 234 88 250 96 L282 112 L268 150 L252 142 L252 212 C252 222 148 222 148 212 L148 142 L132 150 L118 112 Z" fill={selected} />
            ...
            <g>
              <path d="M142 100 C160 90 182 88 200 88 C218 88 240 90 258 100 L290 118 L272 158 L254 148 L254 216 C254 228 146 228 146 216 L146 148 L128 158 L110 118 Z" fill={selected} />
